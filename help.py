...
class help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        tableOfContents.set_footer(text = f'React with the emote corresponding to the category to find out more', icon_url = 'https://cdn.discordapp.com/attachments/818494514867077144/844009816577146900/ghost.jpg')
        ...
        utilities.add_field(name = '!cohortpurge [Aliases = !cp]', value = 'Purges people of cohort roles\nOnly <@524001661379936268> can use it', inline = False)
        utilities.add_field(name = '!countrefresh [Aliases = !cr, !crefresh]', value = 'Refreshes the member count\nOnly Staff can use it', inline = False)
        ...
        utilities.add_field(name = '!gradeshuffle [Aliases = !gs]', value = 'Shuffles all the grades up\nOnly <@524001661379936268> can use it', inline = False)
        utilities.add_field(name = '!id [Aliases = !identification]', value = 'Redirects someone to <#700563120690561024>', inline = False)
        utilities.add_field(name = '!idremove', value = 'Removes <#775418642946064494> from people who are identified\nOnly Staff can use it', inline = False)
        ...
        fun.add_field(name = '!fys @User [Aliases = !fuckoff]', value = 'Tells someone to go fuck themself', inline = False)
        ...
        fun.add_field(name = '!rpsls', value = 'Rock Paper Scissors Lizard Spock (RPS with 5 objects)!', inline = False)
