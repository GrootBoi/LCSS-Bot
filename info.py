...
#Leafs last cup
    ...
    async def leafs(self, ctx):
        ...
        if cupdroughtdays > 0:
            ...
            embed.add_field(name = 'THE LEAFS HAVE set the record for the longest Stanley Cup drought in NHL History', value = 'Date: July 4, 2021', inline = False)
        elif cupdroughtdays < 0:
            embed.add_field(name = f'{cupdroughtdays*(-1)} days since the Leafs have set the record for the longest Stanely Cup drought in NHL History', value = 'Date Set: July 4, 2021', inline = False)
